...
model SimplePumpTurbine "Model of a hydropower system with a reversible pump-turbine"
  ...
  Modelica.Blocks.Sources.Ramp control(
    ...
    height = -0.9,
    offset = 1,
    startTime = 500) annotation (Placement(transformation(origin = {-10, 70}, extent = {{-10, -10}, {10, 10}})));
  ...
  inner OpenHPL.Data data(Vdot_0 = 3)
        ...
        extent = {{-10, -10}, {10, 10}})));
equation
  connect(pumpTurbine.o, discharge.i) annotation (Line(points = {{40, 10}, {44, 10}, {44, 0}, {50, 0}}, color = {28, 108, 200}));
  connect(control.y, pumpTurbine.u_t) annotation (Line(points = {{1, 70}, {16, 70}, {16, 40}, {22, 40}, {22, 22}}, color = {0, 0, 127}));
  connect(penstock.o, pumpTurbine.i) annotation (Line(points = {{10, 30}, {14.95, 30}, {14.95, 10}, {20, 10}}, color = {28, 108, 200}));
